...
class NotificationServiceTest {
    ...
    void createAndSendEmail_SetsIsReadFalse() {
        ...
        savedNotification.setId(1L); // Set ID to avoid NullPointerException
        savedNotification.setUserId(10L);
    ...
    void createAndSendSms_SetsEmptyEmailForSms() {
        ...
        savedNotification.setId(1L); // Set ID to avoid NullPointerException
        savedNotification.setUserId(10L);
        savedNotification.setUserEmail("");
        savedNotification.setStatus(NotificationStatus.SENT); // Set status to avoid NullPointerException in logging
