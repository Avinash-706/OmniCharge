...
class RechargeControllerTest {
    ...
    @Test
    void initiateRecharge_ValidationError_MissingMobileNumber() throws Exception {
        RechargeRequest invalidRequest = new RechargeRequest();
        invalidRequest.setOperatorId(1L);
        invalidRequest.setPlanId(10L);
        invalidRequest.setPaymentMethod("UPI");
    ...
    @Test
    void getRechargeHistory_WithCustomSorting() throws Exception {
        Page<RechargeResponse> page = new PageImpl<>(Collections.singletonList(rechargeResponse));
    ...
    @Test
    void getRechargeHistory_DefaultPagination() throws Exception {
